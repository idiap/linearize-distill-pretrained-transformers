...
def main():
    ...
    for epoch in range(starting_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            progress_bar.desc = f"loss={loss:.4f} lr: {optimizer.param_groups[0]['lr']:.4e} param: {threshold:.3f}"
            ...
            if (step + 1) % args.gradient_accumulation_steps == 0 or step == len(train_dataloader) - 1:
                ...
                if completed_steps % args.eval_interval == 0 or step == len(train_dataloader) - 1:
                    ...
                    if (completed_steps > args.max_train_steps - args.final_warmup * args.warmup_steps
                        or args.no_prune) and list(eval_metric.values())[0] > best_metric['best_metric']:
