#
# SPDX-FileCopyrightText: Copyright © 2025 Idiap Research Institute <contact@idiap.ch>; 2016 The TensorFlow Authors.
#
...
# Adapted from tf.contrib.training.HParams in tf1.x
